...
namespace POSClient.DataLayer.Implement
{
    public class DepartmentStockOutDetailDao : IDepartmentStockOutDetailDao
    {
		...
		public IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<DepartmentStockOutDetail> criteria,Func<DepartmentStockOutDetail,TClass> subProp)
        {
            return (IList<TClass>)HibernateTemplate.Execute(
                                delegate(ISession session)
                                {
                                    ...
                                    QueryHandler<DepartmentStockOutDetail> handler = new QueryHandler<DepartmentStockOutDetail>(session);
                                    IList<DepartmentStockOutDetail> products = handler.GetList(criteria);

...
namespace POSClient.DataLayer.Implement
{
    ...
    public interface ICategoryDao
    {
        ...
        /// <returns></returns>		
        IList<Category> FindAll(LinqCriteria<Category> criteria);

        IList<Category> FindAll(ObjectCriteria<Category> criteria);
		
        object FindFirst(ObjectCriteria<Category> criteria);
        ...
        /// <returns></returns>
        IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<Category> criteria,Func<Category,TClass> subProp);
        ...
        /// <param name="criteria"></param>
        /// <returns></returns>
        int Count(ObjectCriteria<Category> criteria);
        ...
        /// <returns></returns>
        object SelectSpecificType(ObjectCriteria<Category> criteria, IProjection type);

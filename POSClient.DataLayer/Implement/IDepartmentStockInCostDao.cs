...
namespace POSClient.DataLayer.Implement
{
    ...
    public interface IDepartmentStockInCostDao
    {
        ...
        /// <returns></returns>		
        IList<DepartmentStockInCost> FindAll(LinqCriteria<DepartmentStockInCost> criteria);

        IList<DepartmentStockInCost> FindAll(ObjectCriteria<DepartmentStockInCost> criteria);
		
        object FindFirst(ObjectCriteria<DepartmentStockInCost> criteria);
        ...
        /// <returns></returns>
        IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<DepartmentStockInCost> criteria,Func<DepartmentStockInCost,TClass> subProp);
        ...
        /// <param name="criteria"></param>
        /// <returns></returns>
        int Count(ObjectCriteria<DepartmentStockInCost> criteria);
        ...
        /// <returns></returns>
        object SelectSpecificType(ObjectCriteria<DepartmentStockInCost> criteria, IProjection type);

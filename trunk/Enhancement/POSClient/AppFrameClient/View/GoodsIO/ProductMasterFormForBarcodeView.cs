...
namespace AppFrameClient.View.GoodsIO
{
    public partial class ProductMasterFormForBarcodeView : BaseForm, IProductMasterView
    {
        ...
        public ProductMasterFormForBarcodeView()
        {
            InitializeComponent();
        ...
        private void ProductMasterForm_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(ProductMasterId))
            {
                ...
                if (eventArgs.ProductMaster != null)
                {
                    ...
                    txtBarcode.Text = eventArgs.ProductMaster.Barcode;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            var productMaster = new ProductMaster
                                    {
                                        ...
                                        Barcode = string.IsNullOrEmpty(txtBarcode.Text) ? ProductMasterId : txtBarcode.Text,
            ...
            txtBarcode.Text = productMaster.Barcode;
        ...
        private void DrawBarcode(string barcode)
        {
            ...
            Image codeGen = code39.GenerateBarcode(barcode);

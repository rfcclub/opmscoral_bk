...
{
    [PerRequest(typeof(IDepartmentSetViewModel))]
    public class DepartmentSetViewModel : PosViewModel,IDepartmentSetViewModel  
    {

        private IShellViewModel _startViewModel;
        public DepartmentSetViewModel(IShellViewModel startViewModel)
        {

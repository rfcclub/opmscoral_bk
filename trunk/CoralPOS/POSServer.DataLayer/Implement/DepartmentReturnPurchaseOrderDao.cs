...
{
    public class DepartmentReturnPurchaseOrderDaoImpl : IDepartmentReturnPurchaseOrderDao
    {
        ...
        public IList<DepartmentReturnPurchaseOrder> FindAll(ObjectCriteria criteria)
        {
            ...
            try 
            {
                ...
                return hibernateCriteria.List<DepartmentReturnPurchaseOrder>();
            }
            finally 
            {
                if (session != null)
        ...
        private int Count(ObjectCriteria criteria)
        {
            ...
            try 
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(DepartmentReturnPurchaseOrder)).SetProjection(Projections.RowCount()); ;
                if (criteria != null)
                {
                    IDictionary<string, SubObjectCriteria> map = criteria.GetSubCriteria();
                    if (map.Count > 0)

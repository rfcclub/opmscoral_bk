    ...
    public class DepartmentPurchaseOrderPromotionDao : IDepartmentPurchaseOrderPromotionDao
    {
        ...
        public DepartmentPurchaseOrderPromotion Add(DepartmentPurchaseOrderPromotion data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Save("CoralPOS.Models.DepartmentPurchaseOrderPromotion", data);
                        return data;
                    }
                );
        ...
        public int Update(DepartmentPurchaseOrderPromotion data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Update("CoralPOS.Models.DepartmentPurchaseOrderPromotion", data);
                        return 0;
                    }
                );
        ...
        public int Delete(DepartmentPurchaseOrderPromotion data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Delete("CoralPOS.Models.DepartmentPurchaseOrderPromotion", data);
                        return 0;
                    }
                );

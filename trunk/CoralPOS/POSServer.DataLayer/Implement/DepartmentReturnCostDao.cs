    ...
    public class DepartmentReturnCostDao : IDepartmentReturnCostDao
    {
        ...
        public DepartmentReturnCost Add(DepartmentReturnCost data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Save("CoralPOS.Models.DepartmentReturnCost", data);
                        return data;
                    }
                );
        ...
        public int Update(DepartmentReturnCost data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Update("CoralPOS.Models.DepartmentReturnCost", data);
                        return 0;
                    }
                );
        ...
        public int Delete(DepartmentReturnCost data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Delete("CoralPOS.Models.DepartmentReturnCost", data);
                        return 0;
                    }
                );

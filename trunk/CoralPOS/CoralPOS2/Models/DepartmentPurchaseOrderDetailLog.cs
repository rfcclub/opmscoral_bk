...
namespace CoralPOS.Models {
    ...
    [Validate()]
    [DataContract()]
    public class DepartmentPurchaseOrderDetailLog {
        
        public DepartmentPurchaseOrderDetailLog() {
        }
        
        [DataMember(Name="3", Order=3)]
        public virtual DepartmentPurchaseOrderDetailLogPK DepartmentPurchaseOrderDetailLogPK {
            get;
            set;
        }
   	 ...
   	 protected bool Equals(DepartmentPurchaseOrderDetailLog entity)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return Equals(obj as DepartmentPurchaseOrderDetailLog);
		}

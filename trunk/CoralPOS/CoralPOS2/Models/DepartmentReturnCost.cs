...
namespace CoralPOS.Models {
    ...
    [Serializable()]
    public class DepartmentReturnCost {
        
        public DepartmentReturnCost() {
        }
        
        public virtual DepartmentReturnCostPK DepartmentReturnCostPK {
            get;
            set;
        }
   	 ...
   	 protected bool Equals(DepartmentReturnCost entity)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return Equals(obj as DepartmentReturnCost);
		}

...
namespace CoralPOS.Models {
    ...
    [Validate()]
    [DataContract()]
    public class DepartmentPurchaseOrderPromotion {
        
        public DepartmentPurchaseOrderPromotion() {
        }
        
        [DataMember(Name="5", Order=5)]
        public virtual DepartmentPurchaseOrderPromotionPK DepartmentPurchaseOrderPromotionPK {
            get;
            set;
        }
        ...
        public virtual long DepartmentPromotionId {
            get;
            set;
        }
        ...
        public virtual long GiftDepartmentId {
            get;
            set;
        }
   	 ...
   	 protected bool Equals(DepartmentPurchaseOrderPromotion entity)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return Equals(obj as DepartmentPurchaseOrderPromotion);
		}

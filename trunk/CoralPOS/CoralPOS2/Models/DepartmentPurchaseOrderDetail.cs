...
namespace CoralPOS.Models {
    ...
    [Validate()]
    [DataContract()]
    public class DepartmentPurchaseOrderDetail {
        
        public DepartmentPurchaseOrderDetail() {
        }
        
        [DataMember(Name="4", Order=4)]
        public virtual DepartmentPurchaseOrderDetailPK DepartmentPurchaseOrderDetailPK {
            get;
            set;
        }
        ...
        public virtual long PurchaseStatus {
            get;
            set;
        }
        
        [DataMember(Name="18", Order=18)]
        public virtual long PurchaseType {
            get;
            set;
        }
        ...
        public virtual DepartmentPurchaseOrder DepartmentPurchaseOrder {
            get;
            set;
        }
		...
		public override bool Equals(object obj)
		{
			...
			return Equals(obj as DepartmentPurchaseOrderDetail);
		}

...
namespace POSClient.DataLayer.Implement
{
    ...
    public interface IActiveDepartmentDao
    {
        /// <summary>
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        int Update(ActiveDepartment data);
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        int Delete(ActiveDepartment data);
        ...
        /// <returns></returns>		
        IList<ActiveDepartment> FindAll(LinqCriteria<ActiveDepartment> criteria);

        IList<ActiveDepartment> FindAll(ObjectCriteria<ActiveDepartment> criteria);
		
        object FindFirst(ObjectCriteria<ActiveDepartment> criteria);
        ...
        /// <returns></returns>
        IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<ActiveDepartment> criteria,Func<ActiveDepartment,TClass> subProp);
        ...
        /// <param name="criteria"></param>
        /// <returns></returns>
        int Count(ObjectCriteria<ActiveDepartment> criteria);
        ...
        /// <returns></returns>
        object SelectSpecificType(ObjectCriteria<ActiveDepartment> criteria, IProjection type);

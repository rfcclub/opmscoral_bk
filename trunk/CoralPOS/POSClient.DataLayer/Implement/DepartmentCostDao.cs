...
{
    public class DepartmentCostDao : IDepartmentCostDao
    {
        ...
        public DepartmentCost Add(DepartmentCost data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Save("CoralPOS.Models.DepartmentCost", data);
                        return data;
                    }
                );
        ...
        public int Update(DepartmentCost data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Update("CoralPOS.Models.DepartmentCost", data);
                        return 0;
                    }
                );
        ...
        public int Delete(DepartmentCost data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Delete("CoralPOS.Models.DepartmentCost", data);
                        return 0;
                    }
                );
        ...
        /// <returns></returns>
        public IList<DepartmentCost> FindAll(LinqCriteria<DepartmentCost> criteria)
        {
            return (IList<DepartmentCost>) HibernateTemplate.Execute(
                                delegate(ISession session)
                                    {                                        
                                        QueryHandler<DepartmentCost> handler = new QueryHandler<DepartmentCost>(session);
        ...
        public IList<DepartmentCost> FindAll(ObjectCriteria<DepartmentCost> criteria)
        {
            return (IList<DepartmentCost>)HibernateTemplate.Execute(
                                delegate(ISession session)
                                {
                                    IList<DepartmentCost> result = new List<DepartmentCost>();
                                    try
                                    {
                                        ...
                                        result = hibernateCriteria.List<DepartmentCost>();
                                        return result;
                                    }
                                    catch(Exception ex)
                                    {
        ...
        public object FindFirst(ObjectCriteria<DepartmentCost> criteria)
        {
            return HibernateTemplate.Execute(
                                delegate(ISession session)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        result = hibernateCriteria.List<DepartmentCost>()[0];
                                        return result;
                                    }
                                    catch (Exception ex)
                                    {
		...
		public IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<DepartmentCost> criteria,Func<DepartmentCost,TClass> subProp)
        {
            return (IList<TClass>)HibernateTemplate.Execute(
                                delegate(ISession session)
                                {
                                    ...
                                    QueryHandler<DepartmentCost> handler = new QueryHandler<DepartmentCost>(session);
                                    IList<DepartmentCost> products = handler.GetList(criteria);
        ...
        /// <param name="criteria"></param>
        /// <returns></returns>
        public int Count(ObjectCriteria<DepartmentCost> criteria)
        {
                                ...
                                delegate(ISession session)
                                {
                                    ...
                                    try
                                    {
                                        ICriteria hibernateCriteria =
                                            session.CreateCriteria(typeof (DepartmentCost)).SetProjection(Projections.RowCount());
                                        if (criteria != null)
                                        {
                                            PosContext.SetCriteria(hibernateCriteria, criteria);
                                        }
        ...
        /// <returns></returns>
        public object SelectSpecificType(ObjectCriteria<DepartmentCost> criteria, IProjection type)
        {
        ...
        private void SetCriteria(ICriteria hibernateCriteria, ObjectCriteria<DepartmentCost> criteria)
        {
            ...
            foreach (KeyValuePair<Expression<Func<DepartmentCost, object>>, Func<string, Order>> pair in criteria.GetOrder())
            {

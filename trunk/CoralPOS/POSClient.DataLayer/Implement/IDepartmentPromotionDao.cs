...
namespace POSClient.DataLayer.Implement
{
    ...
    public interface IDepartmentPromotionDao
    {
        ...
        /// <returns></returns>		
        IList<DepartmentPromotion> FindAll(LinqCriteria<DepartmentPromotion> criteria);

        IList<DepartmentPromotion> FindAll(ObjectCriteria<DepartmentPromotion> criteria);
		
        object FindFirst(ObjectCriteria<DepartmentPromotion> criteria);
        ...
        /// <returns></returns>
        IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<DepartmentPromotion> criteria,Func<DepartmentPromotion,TClass> subProp);
        ...
        /// <param name="criteria"></param>
        /// <returns></returns>
        int Count(ObjectCriteria<DepartmentPromotion> criteria);
        ...
        /// <returns></returns>
        object SelectSpecificType(ObjectCriteria<DepartmentPromotion> criteria, IProjection type);
    }
}

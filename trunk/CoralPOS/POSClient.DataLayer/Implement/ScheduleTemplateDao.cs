...
namespace POSClient.DataLayer.Implement
{
    public class ScheduleTemplateDao : IScheduleTemplateDao
    {
		...
		public IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<ScheduleTemplate> criteria,Func<ScheduleTemplate,TClass> subProp)
        {
            return (IList<TClass>)HibernateTemplate.Execute(
                                delegate(ISession session)
                                {
                                    ...
                                    QueryHandler<ScheduleTemplate> handler = new QueryHandler<ScheduleTemplate>(session);
                                    IList<ScheduleTemplate> products = handler.GetList(criteria);

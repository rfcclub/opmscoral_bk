...
namespace POSClient.DataLayer.Implement
{
    ...
    public interface IDepartmentStockOutDetailDao
    {
        ...
        /// <returns></returns>		
        IList<DepartmentStockOutDetail> FindAll(LinqCriteria<DepartmentStockOutDetail> criteria);

        IList<DepartmentStockOutDetail> FindAll(ObjectCriteria<DepartmentStockOutDetail> criteria);
		
        object FindFirst(ObjectCriteria<DepartmentStockOutDetail> criteria);
        ...
        /// <returns></returns>
        IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<DepartmentStockOutDetail> criteria,Func<DepartmentStockOutDetail,TClass> subProp);
        ...
        /// <param name="criteria"></param>
        /// <returns></returns>
        int Count(ObjectCriteria<DepartmentStockOutDetail> criteria);
        ...
        /// <returns></returns>
        object SelectSpecificType(ObjectCriteria<DepartmentStockOutDetail> criteria, IProjection type);

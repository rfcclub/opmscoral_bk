...
{
    public class EmployeeWorkingDayDAOImpl : IEmployeeWorkingDayDAO
    {
        ...
        {
            return (EmployeeWorkingDay) HibernateTemplate.Get(typeof(EmployeeWorkingDay), id);
        }
        ...
        {
            EmployeeWorkingDay obj = (EmployeeWorkingDay) HibernateTemplate.Get(typeof (EmployeeWorkingDay), id);
            if (obj != null)
            {
        ...
        public IList FindAll(ObjectCriteria criteria)
        {
            ...
            try 
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(EmployeeWorkingDay));
                if (criteria != null)
                {
        ...
        private int Count(ObjectCriteria criteria)
        {
            ...
            try 
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(EmployeeWorkingDay)).SetProjection(Projections.RowCount()); ;
                if (criteria != null)
                {
                    IDictionary<string, SubObjectCriteria> map = criteria.GetSubCriteria();
                    if (map.Count > 0)
        ...
        public object SelectSpecificType(ObjectCriteria criteria, IProjection type)
        {
            ...
            try
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(EmployeeWorkingDay)).SetProjection(type); ;
                if (criteria != null)
                {
                    IDictionary<string, SubObjectCriteria> map = criteria.GetSubCriteria();
                    if (map.Count > 0)

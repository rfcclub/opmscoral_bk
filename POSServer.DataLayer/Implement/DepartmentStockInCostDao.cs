...
namespace POSServer.DataLayer.Implement
{
    public class DepartmentStockInCostDao : IDepartmentStockInCostDao
    {
		...
		public IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<DepartmentStockInCost> criteria,Func<DepartmentStockInCost,TClass> subProp)
        {
            return (IList<TClass>)HibernateTemplate.Execute(
                                delegate(ISession session)
                                {
                                    ...
                                    QueryHandler<DepartmentStockInCost> handler = new QueryHandler<DepartmentStockInCost>(session);
                                    IList<DepartmentStockInCost> products = handler.GetList(criteria);

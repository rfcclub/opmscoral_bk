...
namespace POSClient.DataLayer.Implement
{
    ...
    public interface IStockOutCostDao
    {
        ...
        /// <returns></returns>		
        IList<StockOutCost> FindAll(LinqCriteria<StockOutCost> criteria);

        IList<StockOutCost> FindAll(ObjectCriteria<StockOutCost> criteria);
		
        object FindFirst(ObjectCriteria<StockOutCost> criteria);
        ...
        /// <returns></returns>
        IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<StockOutCost> criteria,Func<StockOutCost,TClass> subProp);
        ...
        /// <param name="criteria"></param>
        /// <returns></returns>
        int Count(ObjectCriteria<StockOutCost> criteria);
        ...
        /// <returns></returns>
        object SelectSpecificType(ObjectCriteria<StockOutCost> criteria, IProjection type);

    ...
    public class DistributorDao : IDistributorDao
    {
        ...
        public Distributor Add(Distributor data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Save("CoralPOS.Models.Distributor", data);
                        return data;
                    }
                );
        ...
        public int Update(Distributor data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Update("CoralPOS.Models.Distributor", data);
                        return 0;
                    }
                );
        ...
        public int Delete(Distributor data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Delete("CoralPOS.Models.Distributor", data);
                        return 0;
                    }
                );
        ...
        /// <returns></returns>
        public IList<Distributor> FindAll(LinqCriteria<Distributor> criteria)
        {
            return (IList<Distributor>) HibernateTemplate.Execute(
                                delegate(ISession session)
                                    {                                        
                                        QueryHandler<Distributor> handler = new QueryHandler<Distributor>(session);
        ...
        public IList<Distributor> FindAll(ObjectCriteria<Distributor> criteria)
        {
            return (IList<Distributor>)HibernateTemplate.Execute(
                                delegate(ISession session)
                                {
                                    IList<Distributor> result = new List<Distributor>();
                                    try
                                    {
                                        ...
                                        result = hibernateCriteria.List<Distributor>();
                                        return result;
                                    }
                                    catch(Exception ex)
                                    {
        ...
        public object FindFirst(ObjectCriteria<Distributor> criteria)
        {
            return HibernateTemplate.Execute(
                                delegate(ISession session)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        result = hibernateCriteria.List<Distributor>()[0];
                                        return result;
                                    }
                                    catch (Exception ex)
                                    {
		...
		public IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<Distributor> criteria,Func<Distributor,TClass> subProp)
        {
            return (IList<TClass>)HibernateTemplate.Execute(
                                delegate(ISession session)
                                {
                                    ...
                                    QueryHandler<Distributor> handler = new QueryHandler<Distributor>(session);
                                    IList<Distributor> products = handler.GetList(criteria);
        ...
        /// <param name="criteria"></param>
        /// <returns></returns>
        public int Count(ObjectCriteria<Distributor> criteria)
        {
                                ...
                                delegate(ISession session)
                                {
                                    ...
                                    try
                                    {
                                        ICriteria hibernateCriteria =
                                            session.CreateCriteria(typeof (Distributor)).SetProjection(Projections.RowCount());
                                        if (criteria != null)
                                        {
                                            PosContext.SetCriteria(hibernateCriteria, criteria);
                                        }
        ...
        /// <returns></returns>
        public object SelectSpecificType(ObjectCriteria<Distributor> criteria, IProjection type)
        {
        ...
        private void SetCriteria(ICriteria hibernateCriteria, ObjectCriteria<Distributor> criteria)
        {
            ...
            foreach (KeyValuePair<Expression<Func<Distributor, object>>, Func<string, Order>> pair in criteria.GetOrder())
            {

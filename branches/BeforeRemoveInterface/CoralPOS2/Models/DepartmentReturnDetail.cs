...
namespace CoralPOS.Models {
    ...
    [Validate()]
    [DataContract()]
    public class DepartmentReturnDetail {
        
        public DepartmentReturnDetail() {
        }
        
        [DataMember(Name="4", Order=4)]
        public virtual DepartmentReturnDetailPK DepartmentReturnDetailPK {
            get;
            set;
        }
   	 ...
   	 protected bool Equals(DepartmentReturnDetail entity)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return Equals(obj as DepartmentReturnDetail);
		}

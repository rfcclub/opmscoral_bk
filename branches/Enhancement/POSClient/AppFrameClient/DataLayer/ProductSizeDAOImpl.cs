...
{
    public class ProductSizeDAOImpl : IProductSizeDAO
    {
        ...
        {
            return (ProductSize) HibernateTemplate.Get(typeof(ProductSize), id);
        }
        ...
        {
            ProductSize obj = (ProductSize) HibernateTemplate.Get(typeof (ProductSize), id);
            if (obj != null)
            {
        ...
        public IList FindAll(ObjectCriteria criteria)
        {
            ...
            try 
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(ProductSize));
                if (criteria != null)
                {
        ...
        private int Count(ObjectCriteria criteria)
        {
            ...
            try 
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(ProductSize)).SetProjection(Projections.RowCount()); ;
                if (criteria != null)
                {
                    IDictionary<string, SubObjectCriteria> map = criteria.GetSubCriteria();
                    if (map.Count > 0)
        ...
        public object SelectSpecificType(ObjectCriteria criteria, IProjection type)
        {
            ...
            try
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(ProductSize)).SetProjection(type); ;
                if (criteria != null)
                {
                    IDictionary<string, SubObjectCriteria> map = criteria.GetSubCriteria();
                    if (map.Count > 0)

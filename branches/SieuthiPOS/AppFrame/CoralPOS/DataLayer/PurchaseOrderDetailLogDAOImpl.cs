...
{
    public class PurchaseOrderDetailLogDAOImpl : IPurchaseOrderDetailLogDAO
    {
        ...
        {
            return (PurchaseOrderDetailLog) HibernateTemplate.Get(typeof(PurchaseOrderDetailLog), id);
        }
        ...
        {
            PurchaseOrderDetailLog obj = (PurchaseOrderDetailLog) HibernateTemplate.Get(typeof (PurchaseOrderDetailLog), id);
            if (obj != null)
            {
        ...
        public IList FindAll(ObjectCriteria criteria)
        {
            ...
            try 
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(PurchaseOrderDetailLog));
                if (criteria != null)
                {
        ...
        private int Count(ObjectCriteria criteria)
        {
            ...
            try 
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(PurchaseOrderDetailLog)).SetProjection(Projections.RowCount()); ;
                if (criteria != null)
                {
                    IDictionary<string, SubObjectCriteria> map = criteria.GetSubCriteria();
                    if (map.Count > 0)
        ...
        public object SelectSpecificType(ObjectCriteria criteria, IProjection type)
        {
            ...
            try
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(PurchaseOrderDetailLog)).SetProjection(type); ;
                if (criteria != null)
                {
                    IDictionary<string, SubObjectCriteria> map = criteria.GetSubCriteria();
                    if (map.Count > 0)

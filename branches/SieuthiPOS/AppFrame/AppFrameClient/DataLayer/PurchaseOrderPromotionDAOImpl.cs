...
{
    public class PurchaseOrderPromotionDAOImpl : IPurchaseOrderPromotionDAO
    {
        ...
        {
            return (PurchaseOrderPromotion) HibernateTemplate.Get(typeof(PurchaseOrderPromotion), id);
        }
        ...
        {
            PurchaseOrderPromotion obj = (PurchaseOrderPromotion) HibernateTemplate.Get(typeof (PurchaseOrderPromotion), id);
            if (obj != null)
            {
        ...
        public IList FindAll(ObjectCriteria criteria)
        {
            ...
            try 
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(PurchaseOrderPromotion));
                if (criteria != null)
                {
        ...
        private int Count(ObjectCriteria criteria)
        {
            ...
            try 
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(PurchaseOrderPromotion)).SetProjection(Projections.RowCount()); ;
                if (criteria != null)
                {
                    IDictionary<string, SubObjectCriteria> map = criteria.GetSubCriteria();
                    if (map.Count > 0)
        ...
        public object SelectSpecificType(ObjectCriteria criteria, IProjection type)
        {
            ...
            try
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(PurchaseOrderPromotion)).SetProjection(type); ;
                if (criteria != null)
                {
                    IDictionary<string, SubObjectCriteria> map = criteria.GetSubCriteria();
                    if (map.Count > 0)

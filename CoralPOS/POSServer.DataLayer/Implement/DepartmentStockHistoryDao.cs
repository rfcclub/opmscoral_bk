    ...
    public class DepartmentStockHistoryDao : IDepartmentStockHistoryDao
    {
        ...
        public DepartmentStockHistory Add(DepartmentStockHistory data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Save("CoralPOS.Models.DepartmentStockHistory", data);
                        return data;
                    }
                );
        ...
        public int Update(DepartmentStockHistory data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Update("CoralPOS.Models.DepartmentStockHistory", data);
                        return 0;
                    }
                );
        ...
        public int Delete(DepartmentStockHistory data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Delete("CoralPOS.Models.DepartmentStockHistory", data);
                        return 0;
                    }
                );
		...
		public IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<DepartmentStockHistory> criteria,Func<DepartmentStockHistory,TClass> subProp)
        {
            return (IList<TClass>)HibernateTemplate.Execute(
                                delegate(ISession session)
                                {
                                    ...
                                    QueryHandler<DepartmentStockHistory> handler = new QueryHandler<DepartmentStockHistory>(session);
                                    IList<DepartmentStockHistory> products = handler.GetList(criteria);

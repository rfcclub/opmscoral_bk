...
namespace CoralPOS.Models {
    ...
    [Validate()]
    [DataContract()]
    public class MainStockHistory {
        
        public MainStockHistory() {
        }
        
        [DataMember(Name="1", Order=1)]
        public virtual long StockHistoryId {
            get;
            set;
        }
   	 ...
   	 protected bool Equals(MainStockHistory entity)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return Equals(obj as MainStockHistory);
		}

...
namespace CoralPOS.Models {
    ...
    [Validate()]
    [DataContract()]
    public class DepartmentStockInHistory {
        
        public DepartmentStockInHistory() {
        }
        
        [DataMember(Name="5", Order=5)]
        public virtual DepartmentStockInHistoryPK DepartmentStockInHistoryPK {
            get;
            set;
        }
		...
		public override bool Equals(object obj)
		{
			...
			return Equals(obj as DepartmentStockInHistory);
		}

...
namespace POSServer.ViewModels.Stock.StockOut
{
    ...
    public class StockOutViewModel : PosViewModel
    {
        ...
        public void Save()
        {
            ...
            StockOut.ConfirmFlg = SystemConfig.Instance.StockOutConfirm ? 1 : 0;
        ...
        private object PopulateStockOutList(CoralPOS.Models.StockIn selectedStockIn)
        {
            ...
            foreach (StockInDetail inDetail in selectedStockIn.StockInDetails)
            {
                ...
                else
                {
                    ...
                    result.GoodQuantity = result.Quantity;
                }
            }
        ...
        protected override void OnInitialize()
        {
            ...
            else
            {
                ...
                if (SystemConfig.Instance.StockOutConfirm)

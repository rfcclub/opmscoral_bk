...
namespace POSClient.DataLayer.Implement
{
    ...
    public interface IProductUnitDao
    {
        ...
        /// <returns></returns>		
        IList<ProductUnit> FindAll(LinqCriteria<ProductUnit> criteria);

        IList<ProductUnit> FindAll(ObjectCriteria<ProductUnit> criteria);
		
        object FindFirst(ObjectCriteria<ProductUnit> criteria);
        ...
        /// <returns></returns>
        IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<ProductUnit> criteria,Func<ProductUnit,TClass> subProp);
        ...
        /// <param name="criteria"></param>
        /// <returns></returns>
        int Count(ObjectCriteria<ProductUnit> criteria);

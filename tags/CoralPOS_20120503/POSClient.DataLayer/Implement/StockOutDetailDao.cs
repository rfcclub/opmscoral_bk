    ...
    public class StockOutDetailDao : IStockOutDetailDao
    {
        ...
        public StockOutDetail Add(StockOutDetail data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Save("CoralPOS.Models.StockOutDetail", data);
                        return data;
                    }
                );
        ...
        public int Update(StockOutDetail data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Update("CoralPOS.Models.StockOutDetail", data);
                        return 0;
                    }
                );
        ...
        public int Delete(StockOutDetail data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Delete("CoralPOS.Models.StockOutDetail", data);
                        return 0;
                    }
                );
		...
		public IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<StockOutDetail> criteria,Func<StockOutDetail,TClass> subProp)
        {
            return (IList<TClass>)HibernateTemplate.Execute(
                                delegate(ISession session)
                                {
                                    ...
                                    QueryHandler<StockOutDetail> handler = new QueryHandler<StockOutDetail>(session);
                                    IList<StockOutDetail> products = handler.GetList(criteria);

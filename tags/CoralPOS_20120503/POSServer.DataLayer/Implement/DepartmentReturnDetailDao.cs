    ...
    public class DepartmentReturnDetailDao : IDepartmentReturnDetailDao
    {
        ...
        public DepartmentReturnDetail Add(DepartmentReturnDetail data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Save("CoralPOS.Models.DepartmentReturnDetail", data);
                        return data;
                    }
                );
        ...
        public int Update(DepartmentReturnDetail data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Update("CoralPOS.Models.DepartmentReturnDetail", data);
                        return 0;
                    }
                );
        ...
        public int Delete(DepartmentReturnDetail data)
        {
			_hibernateTemplate.Execute(delegate(ISession session) 
                    {
                        session.Delete("CoralPOS.Models.DepartmentReturnDetail", data);
                        return 0;
                    }
                );
		...
		public IList<TClass> FindAllSubProperty<TClass>(LinqCriteria<DepartmentReturnDetail> criteria,Func<DepartmentReturnDetail,TClass> subProp)
        {
            return (IList<TClass>)HibernateTemplate.Execute(
                                delegate(ISession session)
                                {
                                    ...
                                    QueryHandler<DepartmentReturnDetail> handler = new QueryHandler<DepartmentReturnDetail>(session);
                                    IList<DepartmentReturnDetail> products = handler.GetList(criteria);

...
namespace CoralPOS.Models {
    ...
    [Validate()]
    [DataContract()]
    public class CashIoTransaction {
        
        public CashIoTransaction() {
        }
        
        [DataMember(Name="1", Order=1)]
        public virtual string CashInOutTransactionId {
            get;
            set;
        }
        ...
        public virtual long ReasonCode {
            get;
            set;
        }
   	 ...
   	 protected bool Equals(CashIoTransaction entity)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return Equals(obj as CashIoTransaction);
		}

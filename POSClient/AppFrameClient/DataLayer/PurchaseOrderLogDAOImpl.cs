...
{
    public class PurchaseOrderLogDAOImpl : IPurchaseOrderLogDAO
    {
        ...
        {
            return (PurchaseOrderLog) HibernateTemplate.Get(typeof(PurchaseOrderLog), id);
        }
        ...
        {
            PurchaseOrderLog obj = (PurchaseOrderLog) HibernateTemplate.Get(typeof (PurchaseOrderLog), id);
            if (obj != null)
            {
        ...
        public IList FindAll(ObjectCriteria criteria)
        {
            ...
            try 
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(PurchaseOrderLog));
                if (criteria != null)
                {
        ...
        private int Count(ObjectCriteria criteria)
        {
            ...
            try 
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(PurchaseOrderLog)).SetProjection(Projections.RowCount()); ;
                if (criteria != null)
                {
                    IDictionary<string, SubObjectCriteria> map = criteria.GetSubCriteria();
                    if (map.Count > 0)
        ...
        public object SelectSpecificType(ObjectCriteria criteria, IProjection type)
        {
            ...
            try
            {
                ICriteria hibernateCriteria = session.CreateCriteria(typeof(PurchaseOrderLog)).SetProjection(type); ;
                if (criteria != null)
                {
                    IDictionary<string, SubObjectCriteria> map = criteria.GetSubCriteria();
                    if (map.Count > 0)

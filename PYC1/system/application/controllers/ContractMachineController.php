...
class ContractMachineController extends Controller {
	...
	function index() {
	    $this->load->model('ContractMachineModel');
    ...
    function _buildTable($InList, $pageNum, $criteria) {
        ...
        $str .= '<tr class="sort">';
        $str .= '<th> <a class="header_style" href=\'javascript:document.getElementById("action").value ="sort";document.getElementById("hidOrderBy").value ="contractId";document.getElementById("hidPageNum").value ="'.$pageNum.'";document.forms["mainform"].submit();\'>'.$this->lang->line('ContractMachine.contractId').'</a>';
		...
		$str .= '</th>';
        $str .= '<th> <a class="header_style" href=\'javascript:document.getElementById("action").value ="sort";document.getElementById("hidOrderBy").value ="machineId";document.getElementById("hidPageNum").value ="'.$pageNum.'";document.forms["mainform"].submit();\'>'.$this->lang->line('ContractMachine.machineId').'</a>';
    ...
    function _doSearch($criteria, $pageSegment = 0) {
		$DataList = $this->ContractMachineModel->findPaging($criteria);
		$countSearch = $this->ContractMachineModel->count($criteria);
        ...
        if (count($DataList) == 0) {
            ...
            $config['base_url'] = base_url().'index.php?c=contractmachinecontroller&action=next';
